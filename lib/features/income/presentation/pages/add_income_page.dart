...
class _AddIncomePageState extends State<AddIncomePage> {
  ...
  String _selectedSource = AppConfig.incomeSources.first;
  ...
  Future<void> _save() async {
    ...
    if (userId.isEmpty) {
      Get.snackbar('Error', 'User profile not found. Please log in again.');
      return;
    }
    ...
    await _incomeController.addIncome(income);
    Get.back();
  }
